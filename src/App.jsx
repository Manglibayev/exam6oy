    ...
    <div className='w-full h-full bg-slate-900 dark:bg-white'>
      ...
      <div className="mt-24">
        ...
        <div className="flex gap-6 justify-center mt-16">
          <img src="src/assets/b1.jpeg" className='rounded-xl hover:scale-110 duration-200' alt="" />
          <img src="src/assets/b2.jpeg" className='rounded-xl hover:scale-110 duration-200' alt="" />
          <img src="src/assets/b3.jpeg" className='rounded-xl hover:scale-110 duration-200' alt="" />
          <img src="src/assets/b4.jpeg" className='rounded-xl hover:scale-110 duration-200' alt="" />
          <img src="src/assets/b5.jpeg" className='rounded-xl hover:scale-110 duration-200' alt="" />
        </div>
