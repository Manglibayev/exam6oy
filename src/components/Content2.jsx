    ...
    return (
        <div className='flex justify-center'>
            <div className='bg-[url(src/assets/backforcard.jpg)] rounded-2xl bg-no-repeat drop-shadow-lg flex gap-24'>
                <div className="text">
                    <h2 className='text-3xl text-white font-semibold mt-24 pl-8'>Explore New Worlds <br />With Your Custom Deck</h2>
                ...
                <div className="images">
                    <img src="src/assets/character.png" alt="" className='w-[440px] h-[300px] object-cover' />
                </div>
            </div>
        </div>
    )
