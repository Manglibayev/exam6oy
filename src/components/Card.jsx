  ...
  return (
    <div className='rounded-3xl bg-[url(src/assets/background.jpg)] w-[1300px] h-[400px] mx-auto flex mt-36'>
      ...
      <div className='icons flex gap-12 pt-16 pl-20'>
        <img src="public/King_of_the_Sea_profileicon.webp" className='w-[130px] rounded-3xl h-[130px] mt-20' alt="" />
        <img src="public/King_of_the_Sea_profileicon.webp" className='w-[130px] rounded-3xl h-[130px]' alt="" />
        <img src="public/King_of_the_Sea_profileicon.webp" className='w-[130px] rounded-3xl h-[130px] mt-20' alt="" />
        <img src="public/King_of_the_Sea_profileicon.webp" className='w-[130px] rounded-3xl h-[130px]' alt="" />
      </div>
    </div>
